import { normalizeThemeColors } from '@diffdeck/theming/color';
...
// styles
//
// The base foreground/background now flow through @diffdeck/theming's
...
// that @diffdeck/theming's normalizeThemeColors adds, so the emitted string stays
