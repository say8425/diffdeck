// Builds the render-parity harness bundle with the reusable css-inline plugin
// (scripts/css-inline-plugin.ts) so the forked packages' `../style.css?inline`
// imports are inlined as real stylesheet text.
//
