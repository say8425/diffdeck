...
// 호출이 겹치면 자식이 이미 끝났는데도 promise가 영영 settle하지 않는다
// (1.3.12·1.3.14 실측, 업스트림은 1.4.0에서 수정). 여기가 `getDiffFiles`의
// 8-way 버스트라 큰 blob이 섞인 diff는 통째로 45초 flight 타임아웃 → 503이
// 됐다. 같은 작업을 `Bun.spawn`으로는 수천 번 돌려도 걸리지 않았다.
