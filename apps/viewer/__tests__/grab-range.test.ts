...
describe("normalizeRange", () => {
	...
	test("endSide 생략 시 side를 따라감(mixed 아님)", () => {
		expect(normalizeRange({ start: 5, end: 1, side: "deletions" }).kind).toBe("side");
	});
});
